...
function extractKey(arr, key){
    const exKey = arr.map(function(num){
        return num[key];
    })
    return exKey;
}
...
function find(arr, searchValue) {
    const search = arr.filter(function(value){
...
function findInObj(arr, key, searchValue) {
    const searchObj = arr.filter(function(value){
...
function removeVowels(str) {
    ...
    const remove = str.toLowerCase().split('').filter(function(value){
...
function doubleOddNumbers(arr) {
    const doubleOdds = arr.filter(function(num){
        return num % 2 !== 0;
    }).map(function(num){
        return num * 2;
    });
